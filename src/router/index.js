...
const router = createBrowserRouter([
  {
    path: "/",
    element: <Suspense fallback={null}><Home /></Suspense>, // 路由懒加载, 加载时显示 fallback 组件
  },
  {
    path: "/about",
    ...
    children: [
      {
        ...
        element: <Suspense fallback={null}><Other /></Suspense>,
      },
    ],
  },
  {
    path: "/user",
    element: <Suspense fallback={null}><User /></Suspense>,
  },
  {
